...
func (_m *Company) Renter(ctx context.Context) (*Renter, error) {
...
func (_m *Individual) Renter(ctx context.Context) (*Renter, error) {
	result, err := _m.Edges.RenterOrErr()
	if IsNotLoaded(err) {
		result, err = _m.QueryRenter().Only(ctx)
	}
...
func (_m *Tenant) Cars(ctx context.Context) (result []*Car, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = _m.NamedCars(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = _m.Edges.CarsOrErr()
	}
	if IsNotLoaded(err) {
		result, err = _m.QueryCars().All(ctx)
	}
	return result, err
}

func (_m *Tenant) Companies(ctx context.Context) (result []*Company, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
...
func (_m *Tenant) Individuals(ctx context.Context) (result []*Individual, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = _m.NamedIndividuals(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = _m.Edges.IndividualsOrErr()
	}
	if IsNotLoaded(err) {
		result, err = _m.QueryIndividuals().All(ctx)
	}
	return result, err
}

func (_m *Tenant) Options(ctx context.Context) (result []*CarOption, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = _m.NamedOptions(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = _m.Edges.OptionsOrErr()
	}
	if IsNotLoaded(err) {
		result, err = _m.QueryOptions().All(ctx)
	}
	return result, err
}

func (_m *Tenant) RentalOptions(ctx context.Context) (result []*RentalOption, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = _m.NamedRentalOptions(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = _m.Edges.RentalOptionsOrErr()
...
func (_m *Tenant) Rentals(ctx context.Context) (result []*Rental, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = _m.NamedRentals(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = _m.Edges.RentalsOrErr()
...
func (_m *Tenant) Renters(ctx context.Context) (result []*Renter, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
