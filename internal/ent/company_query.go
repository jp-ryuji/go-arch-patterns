...
func (_q *CompanyQuery) QueryTenant() *TenantQuery {
...
func (_q *CompanyQuery) QueryRenters() *RenterQuery {
...
func (_q *CompanyQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *CompanyQuery) FirstIDX(ctx context.Context) string {
...
func (_q *CompanyQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *CompanyQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *CompanyQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *CompanyQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CompanyQuery) WithTenant(opts ...func(*TenantQuery)) *CompanyQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *CompanyQuery) WithRenters(opts ...func(*RenterQuery)) *CompanyQuery {
	query := (&RenterClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CompanyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Company, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Company, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRenters; query != nil {
		if err := _q.loadRenters(ctx, query, nodes,
			func(n *Company) { n.Edges.Renters = []*Renter{} },
			func(n *Company, e *Renter) { n.Edges.Renters = append(n.Edges.Renters, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRenters {
		if err := _q.loadRenters(ctx, query, nodes,
			func(n *Company) { n.appendNamedRenters(name) },
			func(n *Company, e *Renter) { n.appendNamedRenters(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *CompanyQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Company, init func(*Company), assign func(*Company, *Tenant)) error {
...
func (_q *CompanyQuery) loadRenters(ctx context.Context, query *RenterQuery, nodes []*Company, init func(*Company), assign func(*Company, *Renter)) error {
	...
	query.Where(predicate.Renter(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(company.RentersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CompanyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(company.FieldTenantID)
		}
	}
...
func (_q *CompanyQuery) WithNamedRenters(name string, opts ...func(*RenterQuery)) *CompanyQuery {
	query := (&RenterClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
