...
func (_q *CarQuery) QueryTenant() *TenantQuery {
...
func (_q *CarQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *CarQuery) FirstIDX(ctx context.Context) string {
...
func (_q *CarQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *CarQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *CarQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *CarQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CarQuery) WithTenant(opts ...func(*TenantQuery)) *CarQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *CarQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Car, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Car, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *CarQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Car, init func(*Car), assign func(*Car, *Tenant)) error {
...
func (_q *CarQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(car.Table, car.Columns, sqlgraph.NewFieldSpec(car.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(car.FieldTenantID)
		}
	}
