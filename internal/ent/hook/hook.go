...
type CarOptionFunc func(context.Context, *ent.CarOptionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CarOptionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CarOptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CarOptionMutation", m)
}
...
type IndividualFunc func(context.Context, *ent.IndividualMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f IndividualFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.IndividualMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.IndividualMutation", m)
}
...
type RentalOptionFunc func(context.Context, *ent.RentalOptionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RentalOptionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RentalOptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RentalOptionMutation", m)
}

// The RenterFunc type is an adapter to allow the use of ordinary
// function as Renter mutator.
type RenterFunc func(context.Context, *ent.RenterMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RenterFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RenterMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RenterMutation", m)
}
