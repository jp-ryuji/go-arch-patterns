...
func (_c *CarCreate) check() error {
	...
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`ent: missing required field "Car.tenant_id"`)}
	}
	...
	if len(_c.mutation.TenantIDs()) == 0 {
		return &ValidationError{Name: "tenant", err: errors.New(`ent: missing required edge "Car.tenant"`)}
	}
	return nil
}
...
// SetTenantID sets the "tenant_id" field.
func (u *CarUpsert) SetTenantID(v string) *CarUpsert {
	u.Set(car.FieldTenantID, v)
	return u
}

// UpdateTenantID sets the "tenant_id" field to the value that was provided on create.
func (u *CarUpsert) UpdateTenantID() *CarUpsert {
	u.SetExcluded(car.FieldTenantID)
	return u
}
...
// SetTenantID sets the "tenant_id" field.
func (u *CarUpsertOne) SetTenantID(v string) *CarUpsertOne {
	return u.Update(func(s *CarUpsert) {
		s.SetTenantID(v)
	})
}
...
// UpdateTenantID sets the "tenant_id" field to the value that was provided on create.
func (u *CarUpsertOne) UpdateTenantID() *CarUpsertOne {
	return u.Update(func(s *CarUpsert) {
		s.UpdateTenantID()
	})
}
...
func (u *CarUpsertOne) ID(ctx context.Context) (id string, err error) {
...
func (u *CarUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetTenantID sets the "tenant_id" field.
func (u *CarUpsertBulk) SetTenantID(v string) *CarUpsertBulk {
	return u.Update(func(s *CarUpsert) {
		s.SetTenantID(v)
	})
}
...
// UpdateTenantID sets the "tenant_id" field to the value that was provided on create.
func (u *CarUpsertBulk) UpdateTenantID() *CarUpsertBulk {
	return u.Update(func(s *CarUpsert) {
		s.UpdateTenantID()
	})
}
